<?php
	...
	$required_fields = array("name", "email", "phone", "message", "appointment-date", "appointment-time");
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$date       = test_input($_POST["appointment-date"]);
		$time       = test_input($_POST["appointment-time"]);
	...
	if ( $email->Send() ) {
		$customer_message = '<p>Your appointment inquiry has been sent.</p>';
